	...
	<tr>
 		...
 		<td>
			...
			function checksearch()
			{
				...
				checkboxes = document.getElementsByName('studentgroupstodelete[]');
 	...
 	<tr>
<form  method='post'  action='./scripts/deletestudentgroups.php'  name='manage_accounts'>
 			...
 			<table id='listtable'>
				...
				<?php
					...
					while($r=mysqli_fetch_array($res))
					{
						...
						echo ">
						<td>
							<input type='checkbox' name='studentgroupstodelete[]' value='$groupid'>
					 	</td>
					 	<td>
						...
						<td>
							<a href='./new_student_group.php?edit=$groupid'><img src='./assets/edit.png'  onMouseOver=\"this.src='./assets/edit_hover.png'\" onMouseOut=\"this.src='./assets/edit.png'\"/></a>
				 		</td>
						</tr>
						";
						$i++;
